...
public class SearchByName {
    ...
    public String GetSearch() throws SQLException {
        ...
        PreparedStatement pst = (PreparedStatement) aDBconnection.GetConnection().prepareStatement("Select p.p_id,p.p_name,p.p_cat,p.price,i.quantity  from product as p,inventory as i where p.p_name=? and   p.p_id=i.p_id;");
